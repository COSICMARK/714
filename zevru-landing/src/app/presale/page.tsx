...
export default function PresalePage() {
  ...
  return (
    <main className="flex-grow min-h-screen bg-[#0066cc] flex items-center justify-center px-4 py-12">
      ...
      >
        <h1 className="text-3xl sm:text-4xl font-extrabold text-center mb-6 text-[#003366]">
          🐱 Zevru Presale
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4 p-5 bg-[#f4f9ff] rounded-xl border border-[#0066cc]">
            ...
            <h2 className="text-lg font-semibold text-[#0066cc]">Presale Details</h2>
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div>
                <span className="text-gray-600">Total Token Supply</span>
                <div className="font-bold text-[#003366]">{tokenSupplyDisplay}</div>
              </div>
              <div>
                <span className="text-gray-600">Presale Supply</span>
                <div className="font-bold text-[#003366]">{presaleCapDisplay}</div>
              </div>
              <div>
                <span className="text-gray-600">Valuation (FDV)</span>
                <div className="font-bold text-[#003366]">$2,000,000</div>
              </div>
              <div>
                <span className="text-gray-600">Price per Token</span>
                <div className="font-bold text-[#003366]">$0.001</div>
              </div>
              <div>
                <span className="text-gray-600">Pair</span>
                <div className="font-bold text-[#003366]">USDT / USDC (Base)</div>
              </div>
              <div>
                <span className="text-gray-600">Tokens Sold</span>
                <div className="font-bold text-[#003366]">{tokensSoldDisplay}</div>
              </div>
            </div>

            <div className="mt-6">
              <div className="flex justify-between text-sm font-bold mb-1 text-[#003366]">
                <span>Min $200k</span>
          ...
          <div className="p-5 bg-[#f8fbff] rounded-xl border border-[#0066cc]">
            <div ref={termsRef} className="mb-4 bg-white p-3 rounded text-sm border">
              <h3 className="font-bold mb-2 text-[#0066cc]">Terms & Conditions</h3>
            ...
            {hasMounted && isConnected ? (
              <>
                ...
                <div className="mb-3">
                  ...
                  />
                  <p className="text-xs text-gray-600 mt-2">
                    Receive: <span className="font-bold">{receiveString} Zevru</span>
                  </p>
                </div>
                ...
                <button
                  ...
                  className={`w-full py-3 font-bold rounded ${!agreed || loading ? "bg-gray-300 text-gray-500" : "bg-[#0066cc] text-white hover:opacity-90"}`}
                >
                ...
                {txHash && (
                  <div className="mt-4 text-sm bg-white p-3 rounded border">
                    <p className="font-semibold text-[#00aa66]">Success 🎉</p>
                    <p>
                      View transaction:{" "}
                      <a
