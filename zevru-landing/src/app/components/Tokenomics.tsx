export default function Tokenomics() {
  return (
    <div className="notebook space-y-8">
      <h2 className="text-4xl text-pink-600 font-caveat">
        📜 Zevru Tokenomics
      </h2>

      <p className="text-xl font-indie text-gray-800">
      ...
      <p className="text-xl font-shadows text-gray-800">
        The tokenomics are super simple, totally clear,  
        and built to grow a strong crew of holders.
      </p>

      <ul className="list-none space-y-3 pl-2 font-patrick text-lg text-gray-900">
        <li>
          ➤ Community – 70%
          <ul className="ml-6 list-none space-y-1">
            <li>✏️ NFT Holders: 40%</li>
            <li>✏️ Airdrop: 60%</li>
      ...
      <p className="text-lg font-gloria text-gray-700">
        Total supply: TBA ✍️
      </p>
