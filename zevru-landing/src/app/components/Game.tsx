  ...
  return (
    <main className="min-h-screen relative overflow-hidden flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white p-6">
      ...
      <div className="w-full max-w-5xl mx-auto relative z-10">
        ...
        >
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-blue-300 to-blue-500 bg-clip-text text-transparent drop-shadow-lg">
              Zevru — Tap to Charge ⚡
            </h1>
            ...
            {wallet ? (
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md px-4 py-2 rounded-xl border border-blue-500/30 shadow">
                <div className="text-right">
                  ...
                  <div className="font-mono text-sm truncate max-w-[140px]">{wallet}</div>
                </div>
                <button
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-between mb-6 gap-3">
            <div className="flex items-center gap-4">
              <div className="rounded-xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 px-4 py-3 shadow-inner border border-blue-400/30">
                ...
                <div className="text-3xl font-bold text-blue-300 animate-pulse">{energyLabel}</div>
              </div>
              <div className="rounded-xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 px-4 py-3 border border-blue-400/30">
                ...
                <div className="text-lg font-semibold">{stage + 1} / {evolutionStages.length}</div>
              </div>
              <div className="rounded-xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 px-4 py-3 border border-blue-400/30">
                <div className="text-xs text-slate-300">Taps (stage)</div>
                <div className="text-lg font-semibold">{tapsThisStage}</div>
              </div>
            </div>
          ...
          <AnimatePresence>
            {popups.map((p) => (
              ...
              >
                <div className="px-4 py-1 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold text-sm shadow-lg">
                  +{ENERGY_PER_TAP}
                </div>
              </motion.div>
            ))}
          ...
          <div className="mt-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-5 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold shadow-lg hover:scale-105 active:scale-95 transition"
              >
                Sync Now
              </button>
              <button
